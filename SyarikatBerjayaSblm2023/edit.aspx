<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" EnableEventValidation="false"  Inherits="EPBM.SyarikatBerjayaSblm2023.edit" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <div>
                                ...
                                <asp:TextBox ID="txttempoh" runat="server" class="form-control mb-3" type="text" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <label class="control-label">Tahun Lantikan <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtahunlantikan" runat="server" required="required" type='date' autocomplete="off" onkeydown="return false" class="form-control mb-3" AutoPostBack="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">                            
...
<br />
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div>
                                    <label class="control-label">NamaSyarikat</label>
                                    <asp:TextBox ID="txtNamaSyarikat" runat="server" class="form-control mb-3" type="text" autocomplete="off"></asp:TextBox>
                                </div>
                            </div>
