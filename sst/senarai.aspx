<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="senarai.aspx.cs" Inherits="EPBM.sst.senarai" %>
	...
	<div id="advancedSearch" class="card">
		...
		<div class="row card-body">
				...
				<div class="col-12 text-end">
					<asp:HyperLink ID="btnReset" NavigateUrl="/sst/senarai.aspx" runat="server" CssClass="btn btn-outline-danger" >RESET</asp:HyperLink>
					<asp:LinkButton ID="btnSubmit2" CssClass="btn btn-primary" runat="server" OnClick="SearchExtend" PostBackUrl="~/sst/senarai.aspx" CausesValidation="false">CARI</asp:LinkButton>
				</div>
		</div>
	</div>
	<div class="card">
		<div class="card-body table-responsive">
			<div class="row input-group-sm justify-content-between">
				...
				<div class="col-sm-3 col-md-2 mb-3 text-end">
					<asp:LinkButton ID="btnCetak" Visible="false" CssClass="btn btn-info btn-sm" runat="server" CommandArgument="basic" PostBackUrl="~/keputusan/cetak-senarai.aspx" ><i class="align-middle" data-feather="printer"></i> Cetak</asp:LinkButton>
				</div>
			</div>
			<asp:GridView 
				ID="GridView1" 
					...
					<asp:TemplateField HeaderText="KETERANGAN" HeaderStyle-CssClass="text-center">
						<ItemTemplate>
							<asp:ListView runat="server"  ID="DetailsList">
								...
								<ItemTemplate>
									<li class="list-group-item p-1"><b><%#: Eval("Label") %>:</b> <br /><%#: Eval("Text") %></li>
								</ItemTemplate>
							</asp:ListView>
						</ItemTemplate>
					</asp:TemplateField>
