	...
	<div class="card">
		...
		<div class="card-body table-responsive">
			<table class="table table-bordered table-striped table-hover">
                <asp:GridView ID="Senarai" runat="server" AutoGenerateColumns="False" EmptyDataText="Tiada Rekod Dijumpai." ShowHeaderWhenEmpty="True" CssClass="table table-striped table-bordered table-hover Grid" OnDataBound="Senarai_DataBound">
                    <Columns>
